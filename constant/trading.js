...
const MOVING_AVERAGE_MINUTE_BASE_TIME = 1;

const MOVING_AVERAGE_MINUTE = Object.freeze({
	FIVE: MOVING_AVERAGE_MINUTE_BASE_TIME + 5,
	TWENTY: MOVING_AVERAGE_MINUTE_BASE_TIME + 20,
	SIXTY: MOVING_AVERAGE_MINUTE_BASE_TIME + 60,
});

const TICKER_REQUEST_TIMING = 60 * MILLISECONDS;

const TRADE_REQUEST_TIMING = 61 * MILLISECONDS;
