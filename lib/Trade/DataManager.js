...
class TradeDataManager {
  ...
  pushHistory(data) {
    ...
    console.log(`[Data Manager] "${this.ticker}" added... (${this.tickerHistories.length})`);
  ...
  async pushOrderHistory(data, orderReason) {
    ...
    try {
      ...
      console.log(`[Data Manager] push order history failed: ${error}`);
      return error;
    }
  }
  ...
  #findBid(orderId) {
    return new Promise((resolve, reject) => {
      try {
        ...
        console.log(`[Data Manager] find bid from bids failed: ${error}`);
        reject(error);
      }
    });
  }
  ...
  #findAsk(orderId) {
    return new Promise((resolve, reject) => {
      try {
        ...
        console.log(`[Data Manager] find ask from asks failed: ${error}`);
        reject(error);
      }
    });
  }
  ...
  #insertData(orderData) {
    return new Promise((resolve, reject) => {
      try {
        ...
        console.log(`[Data Manager] insert bid/ask data failed: ${error}`);
        reject(error);
      }
    });
  }
  ...
  #insertTrade(id, type, reason) {
    return new Promise((resolve, reject) => {
      try {
        ...
        console.log(`[Data Manager] insert trade from trades failed: ${error}`);
        reject(error);
      }
    });
  }
